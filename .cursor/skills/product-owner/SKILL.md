...
| Go gateway caches Redis quotes only          | Investors see near-real-time prices on watchlists without lag      |
| Configure EXPO_PUBLIC_API_BASE_URL           | Mobile users reach the same API as web without broken sessions     |
