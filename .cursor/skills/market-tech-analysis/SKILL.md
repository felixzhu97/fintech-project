...
description: >-
  ...
  user asks for market analysis, tech analysis, commercial dynamics,
  tech–business recommendations, competitors, or trend assessment.
...
- Planning features, monetization, or platform bets for fintech / portfolio / market-data products
...
4. Tie advice to **this repo’s capabilities** when analyzing FinPulse (portfolio, watchlists, quotes, trading/payments, React admin/portal, React Native mobile, Go gateway, FastAPI analytics) — or state clearly if the analysis is industry-generic.
...
- Fit with existing stack (React/Emotion, React Native/Expo, Go/pgx, FastAPI, TimescaleDB, Redis, Kafka)
...
| Ignoring this codebase | Call out reuse of portfolio/quotes/analytics vs greenfield |
...
| Implement in monorepo | [developer](../developer/SKILL.md) + [architecture rule](../../rules/architecture.mdc) |
